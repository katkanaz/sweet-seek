...
function ResultDetail() {
    ...
    const {
        ...
        isLoading,
        isError,
    } = useQuery<ComputedStructure, Error>({
    ...
    const handleAlignClick = (motif: Motif, num: number) => {
        ...
        window.molstar.clear().then(async () => {
            ...
            structure
                .component({ selector: "branched" })
                .representation({ type: "carbohydrate" })
                .color({
                        ...
                        <TableContainer>
                            <Table variant="striped" colorScheme="whiteAlpha" size="sm">
                                <Tbody>
                                    ...
                                    <Tr>
                                        <Td width="2" fontWeight="bold" px="0">
                                            Total number of motif matches:
                                        </Td>
                                        <Td>
                                            {compStruct.accepted_motifs.length +
                                                (compStruct.rejected_motifs?.length ?? 0)}
                                        </Td>
                                    </Tr>
                                </Tbody>
                            </Table>
